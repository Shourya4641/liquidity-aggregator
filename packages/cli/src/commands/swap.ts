      ...
      const answers = await inquirer.prompt([
        {
          ...
          validate: (input: string) => this.validator.validateToken(input)
        },
        {
          type: 'input',
          name: 'tokenOut',
        ...
        },
        {
          ...
          validate: (input: string) => this.validator.validateAmount(input)
        },
        {
          type: 'input',
          name: 'slippage',
          ...
          default: '0.5',
          validate: (input: string) => this.validator.validateSlippage(input)
        }
      ]);
